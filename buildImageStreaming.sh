...
exec $CXX --std=c++0x -g $PROFILING_FLAGS -o streamingMain streamingMain.cpp findCircle.cpp globals.cpp configReader.cpp filtering.o -ljpeg -pthread $EXTRA_FLAGS -lX11 -lv4l2 `pkg-config --libs ck`
